...
import dito.asset.Asset;
import dito.asset.AssetManager;
import dito.asset.entity.Entity;
import dito.asset.entity.player.Player;
import dito.asset.object.Object;
import dito.asset.tile.TileManager;
import dito.asset.tile.interactive.InteractiveTile;
import dito.connection.GameStateDAO;
import dito.event.EventHandler;
import dito.sound.SoundManager;
import dito.ui.UI;
import dito.util.CollisionChecker;
import dito.util.Config;
import dito.util.KeyHandler;
...
public class GamePanel extends JPanel implements Runnable {
    ...
    public void saveGameState() {
        ...
        System.out.println("Saving game state for player level: " + player.getLevel());
        dao.saveGameState(this);
    }
    
    public void loadGameState() {
        gameStateDAO.loadGameState(this);
    }
    ...
    public void endGame() {
        saveGameState();
        gameStateDAO.saveGameState(this);
    }
    ...
    public void levelUp() {
        ...
        System.out.println("Player level updated to: " + player.getLevel());
    }
    public void onPlayerLevelUp() {
        levelUp();
        System.out.println("Player leveled up to: " + getPlayer().getLevel());
    }
